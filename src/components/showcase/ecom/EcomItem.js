...
function EcomItem({props}) {
    ...
    return (
        <div className='ecomItem'>
            <div className='ecomItem__image'
            onClick={()=>{
            ...
            <div className='ecomItem__description'
            onClick={()=>{
                dispatch(setProductClicked({clicked: true, props: toAdd, toShow:images[0]}))
            }}>
                {description}
            ...
            <div className='ecomItem__price'
            onClick={()=>{
                dispatch(setProductClicked({clicked: true, props: toAdd, toShow:images[0]}))
            }}>
                &#8369;{price.toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
            </div>
            <div className='ecomItem__rating'>
                <div
                onClick={()=>{
                    dispatch(setProductClicked({clicked: true, props: toAdd, toShow:images[0]}))
                }}>
                ...
                className='ecomItem__addToCart'>Add to cart</button>
            </div>
